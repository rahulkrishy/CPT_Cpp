...
-std::vector automatically grows its capacity to accommodate for new items, if the old capacity is not enough
...
int main(){
    ...
    //std::cout << " numbers.at(30) (throws exception): " << numbers.at(30) << std::endl;
