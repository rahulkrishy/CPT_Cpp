...
View composition refers to the process of combining multiple views or range adaptors together to create a new view 
that represents a sequence of transformations applied to a range.

Pipe operator (|):
the pipe operator (|) is used in conjunction with STL views and range adaptors to create chained transformations on ranges. 
It allows you to compose multiple operations together in a single expression, making your code more expressive and concise.
*/
