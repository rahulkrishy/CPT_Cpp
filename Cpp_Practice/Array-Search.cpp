// program takes user-inputted array numbers, displays them, and searches for a specified number, providing its index if found.
...
int main()
{
  ...
  int a[100], count, findNum, numFlag = 0, index;
